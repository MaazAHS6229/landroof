                    ...
                    <tr>
                        ...
                        <th class="leads_col_no">
                            <a class="js-ajax-ux-request js-list-sorting" id="sort_lead_no" href="javascript:void(0)"
                                data-url="{{ urlResource('/leads?action=sort&orderby=lead_title&sortorder=asc') }}">{{ cleanLang(__('lang.s_no')) }}<span class="sorting-icons"><i class="ti-arrows-vertical"></i></span>
                            </a>
                        </th>
