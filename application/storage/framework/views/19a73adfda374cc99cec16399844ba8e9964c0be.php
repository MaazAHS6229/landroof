...
<div class="p-t-25 invoice-pay text-right hidden" id="invoice-pay-container">
    ...
    <div class="x-options" id="invoice-pay-options-container">
        ...
        <div class="x-checkbox">
            ...
            <input name="group5" type="radio" id="radio_payment_mollie" data-gateway-id="gateway-mollie" data-button-id="gateway-mollie"
        ...
        <div class="x-checkbox">
            ...
            <input name="group5" type="radio" id="radio_payment_tap" data-gateway-id="gateway-tap" data-button-id="gateway-tap"
                data-url="<?php echo e(url('invoices/'.$bill->bill_invoiceid.'/tap-payment')); ?>"
                class="invoice-pay-gateway-selector with-gap radio-col-green">
...
</div><?php /**PATH /home/visom6/crm_visom6_com/application/resources/views/pages/pay/buttons.blade.php ENDPATH**/ ?>