...
<div class="col-md-12  col-lg-5 align-self-center text-right p-b-9  <?php echo e($page['list_page_actions_size'] ?? ''); ?> <?php echo e($page['list_page_container_class'] ?? ''); ?>"
    ...
    <div id="list-page-actions">
        <?php if(auth()->user()->is_team && auth()->user()->role->role_estimates >= 2): ?>
        <!--reminder-->
        ...
        <span class="dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="listTableAction">
                <a class="dropdown-item"
                    href="<?php echo e(url('/estimates/'.$bill->bill_estimateid.'/edit-estimate')); ?>"><?php echo e(cleanLang(__('lang.edit_estimate'))); ?></a>
                <!--change status-->
        ...
        <a data-toggle="tooltip" title="<?php echo e(cleanLang(__('lang.download'))); ?>" id="estimateDownloadButton"
            href="<?php echo e(url('/estimates/'.$bill->bill_estimateid.'/pdf')); ?>"
            class="list-actions-button btn btn-page-actions waves-effect waves-dark" download>
            <i class="mdi mdi-download"></i>
        </a>

    </div>
</div><?php /**PATH /home/visom6/crm_visom6_com/application/resources/views/pages/bill/components/misc/estimate/actions.blade.php ENDPATH**/ ?>