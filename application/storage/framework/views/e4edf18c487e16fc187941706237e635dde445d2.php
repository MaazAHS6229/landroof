...
<div class="comment-widgets" id="ticket_reply_<?php echo e($reply->ticketreply_id); ?>">
    <div class="d-flex flex-row comment-rowp-b-0">
        ...
        <div class="comment-text w-100">
            ...
            <div class="text-muted m-b-5"><small class="text-muted">
                    ...
                    (<?php echo e(runtimeDateAgo($reply->ticketreply_created)); ?>)</small></div>
            ...
            <div class="text-right">
                ...
                <small><a class="text-muted confirm-action-danger" href="javascript:void(0);"
                        ...
                        data-ajax-type="DELETE" data-url="<?php echo e(url('tickets/'.$reply->ticketreply_id.'/delete-reply')); ?>"><?php echo app('translator')->get('lang.delete'); ?></a></small>
            </div>
            <?php endif; ?>
        </div>
    </div>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/visom6/crm_visom6_com/application/resources/views/pages/ticket/components/replies.blade.php ENDPATH**/ ?>