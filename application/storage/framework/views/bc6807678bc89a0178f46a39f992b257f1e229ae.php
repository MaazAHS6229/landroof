<div class="invoice-item-actions">
    ...
    <button type="button" id="billing-time-actions-blank"
        class="btn btn-secondary btn-rounded btn-sm btn-rounded-icon"><i
            class="mdi mdi-clock text-themecontrast"></i>
...
</div><?php /**PATH /home/visom6/crm_visom6_com/application/resources/views/pages/bill/components/misc/add-line-buttons.blade.php ENDPATH**/ ?>