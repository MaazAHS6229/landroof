    ...
    <td class="td-checkbox">
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <span class="align-middle text-info display-inline-block m-t-5 font-16" data-toggle="tooltip"
                title="<?php echo e($field->customfields_name); ?>" data-placement="top"><i class="ti-info-alt"></i></span>
        </span>
    </td>
</tr>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/visom6/crm_visom6_com/application/resources/views/pages/settings/sections/customfields/ajax.blade.php ENDPATH**/ ?>