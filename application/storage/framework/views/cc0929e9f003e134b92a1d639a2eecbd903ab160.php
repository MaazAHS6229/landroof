    ...
    <div class="col-sm-12 col-md-4 col-lg-3" id="logfile_<?php echo e($key); ?>">
        <div class="error-log">
            ...
            <button type="button" class="btn btn-danger btn-sm btn-xs confirm-action-danger"
                ...
                data-url="<?php echo e(url('settings/errorlogs/delete?key='.$key.'&filename='.$log->getFilename())); ?>">
...
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/visom6/crm_visom6_com/application/resources/views/pages/settings/sections/errorlogs/page.blade.php ENDPATH**/ ?>