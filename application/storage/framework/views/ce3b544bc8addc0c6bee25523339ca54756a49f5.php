...
<div id="webform-builder-wraper" class="p-t-40">
    ...
    <script>
        ...
        //all custom fields
        NXBUILDER.custom_field = JSON.parse('<?php echo json_encode($custom_fields); ?>', true);

        //existing form fields
        NXBUILDER.current_field = JSON.parse('<?php echo json_encode($current_fields); ?>', true);
    </script>
</div>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('pages.settings.ajaxwrapper', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/visom6/crm_visom6_com/application/resources/views/pages/settings/sections/formbuilder/build/page.blade.php ENDPATH**/ ?>