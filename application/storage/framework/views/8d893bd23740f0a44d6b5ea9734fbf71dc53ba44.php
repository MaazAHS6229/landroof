    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-light">
        ...
        <div class="navbar-collapse header-overlay" id="main-top-nav-bar">
            ...
            <ul class="navbar-nav navbar-top-right my-lg-0" id="right-topnav-navbar">
                ...
                <li class="nav-item dropdown <?php echo e(request('user_has_due_reminder')); ?> d-none d-sm-block" id="topnav-reminders-dropdown"
                ...
                <li class="nav-item">
                    <a class="nav-link waves-effect waves-dark font-22 p-t-10 p-r-10"
                        href="<?php echo e(url('/messages')); ?>" aria-expanded="false">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right">
                        ...
                        <a class="dropdown-item dropdown-item-iconed"
                            href="<?php echo e(url('/tickets/create')); ?>">
...
</header><?php /**PATH /home/visom6/crm_visom6_com/application/resources/views/nav/topnav.blade.php ENDPATH**/ ?>