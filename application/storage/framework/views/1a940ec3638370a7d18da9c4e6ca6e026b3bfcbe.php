            ...
            <table id="contracts-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contract-list"
                ...
                <thead>
                    <tr>
                        ...
                        <!--doc_value-->
                        <th class="col_doc_date_start"><a class="js-ajax-ux-request js-list-sorting" id="sort_doc_value"
                                href="javascript:void(0)"
...
</div><?php /**PATH /home/visom6/crm_visom6_com/application/resources/views/pages/contracts/components/table/table.blade.php ENDPATH**/ ?>