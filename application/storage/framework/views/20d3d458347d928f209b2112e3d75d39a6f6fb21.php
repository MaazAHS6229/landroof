            ...
            <table id="leads-list-table" class="table m-t-0 m-b-0 table-hover no-wrap contact-list" data-page-size="10">
                <thead>
                    <tr>
                        ...
                        <?php endif; ?>
                        <th class="leads_col_no">
                            <a class="js-ajax-ux-request js-list-sorting" id="sort_lead_no" href="javascript:void(0)"
                                data-url="<?php echo e(urlResource('/leads?action=sort&orderby=lead_title&sortorder=asc')); ?>"><?php echo e(cleanLang(__('lang.s_no'))); ?><span class="sorting-icons"><i class="ti-arrows-vertical"></i></span>
                            </a>
                        </th>
...
</div><?php /**PATH /home/visom6/crm_visom6_com/application/resources/views/pages/leads/components/table/table.blade.php ENDPATH**/ ?>