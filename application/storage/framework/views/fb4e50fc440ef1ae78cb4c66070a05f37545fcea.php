...
<aside class="left-sidebar settings-menu">
            ...
            <ul id="sidebarnav">
                ...
                <li class="sidenav-menu-item">
                    <a class="has-arrow waves-effect waves-dark" href="javascript:void(0);" aria-expanded="false"
                        ...
                        <span class="hide-menu"><?php echo e(cleanLang(__('lang.webmail'))); ?>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="javascript:void(0);" data-url="/settings/webmail/templates"
                                ...
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url"><?php echo e(cleanLang(__('lang.templates'))); ?></a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse" id="settings-menu-other">
                        <li><a href="javascript:void(0);" data-url="/settings/recaptcha" id="settings-menu-other-recaptch"
                ...
                <li class="sidenav-menu-item">
                    ...
                    <ul aria-expanded="false" class="collapse" id="settings-menu-other">
                        <li><a href="javascript:void(0);" data-url="/settings/recaptcha" id="settings-menu-other-recaptcha"
                                class="settings-menu-link js-ajax-ux-request js-submenu-ajax js-dynamic-settings-url">reCAPTCHA</a>
                        </li>
                    </ul>
                </li>
    ...
    <!-- End Sidebar scroll-->
</aside><?php /**PATH /home/visom6/crm_visom6_com/application/resources/views/pages/settings/leftmenu-settings.blade.php ENDPATH**/ ?>