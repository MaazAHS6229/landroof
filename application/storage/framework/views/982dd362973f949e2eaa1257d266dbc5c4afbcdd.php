...
<tr id="lead_<?php echo e($lead->lead_id); ?>">
    ...
    <td class="leads_col_action actions_column" id="leads_col_action_<?php echo e($lead->lead_id); ?>">
        ...
        <span class="list-table-action dropdown font-size-inherit">
            ...
            <!--Whatsapp-->
            <button type="button" title="<?php echo e(cleanLang(__('lang.whatsapp'))); ?>"
                ...
                <img src="https://cdn3.iconfinder.com/data/icons/2018-social-media-logotypes/1000/2018_social_media_popular_app_logo-whatsapp-256.png" alt="" srcset="" style="width: 21px; height:22px">
            </button>
            <!--Phone-->
            <button type="button" title="<?php echo e(cleanLang(__('lang.phone'))); ?>"
                class="data-toggle-action-tooltip btn btn-outline-danger btn-circle btn-sm show-modal-button reset-card-modal-form js-ajax-ux-request"
                data-loading-target="main-top-nav-bar">
                <i class="ti-mobile"></i>
            </button>
            <!--view-->
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<!--each row--><?php /**PATH /home/visom6/crm_visom6_com/application/resources/views/pages/leads/components/table/ajax.blade.php ENDPATH**/ ?>